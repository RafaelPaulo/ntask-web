    ...
    _createClass(App, [{
        ...
        value: function tasksEvents() {
            ...
            this.tasks.on('error', function () {
                return alert('Error trying to list');
            });
            this.tasks.on('remove-error', function () {
                return alert('Error trying to exclude');
            });
            this.tasks.on('update-error', function () {
                return alert('Error trying to update');
            });
        ...
        value: function userEvents() {
            ...
            this.user.on('error', function () {
                return alert('Error trying to show user');
            });
            this.user.on('remove-error', function () {
                return alert('Error trying to exclude the account');
            });
...
var Signup = function (_Ntask) {
    ...
    _createClass(Signup, [{
        ...
        value: function render() {
            ...
            this.body.querySelector('[data-name]');
            this.addEventListener();
        }
    }, {
        key: 'addEventListener',
...
exports.render = function () {
    return "\n        <form>\n            <div class=\"list\">\n                <label class=\"item item-input item-stacked-label\">\n                    <span class=\"input-label\">Name</span>\n                    <input type=\"text\" data-name>\n                </label>\n                <label class=\"item item-input item-stacked-label\">\n                    <span class=\"input-label\">Email</span>\n                    <input type=\"text\" data-email>\n                </label>\n                <label class=\"item item-input item-stacked-label\">\n                    <span class=\"input-label\">Password</span>\n                    <input type=\"password\" data-password>\n                </label>\n            </div>\n            <div class=\"padding\">\n                    <button class=\"button button-positive button-block\">\n                        <i class=\"ion-thumbsun\"></i> Sign up\n                    </button>\n            </div>\n        </form>\n    ";
};
...
exports.render = function (tasks) {
    ...
    return '<h4 class="text-center">No tasks yet</h4>';
};
